...
[_M_BASE_COLEMAK] = LAYOUT_pretty(
    ...
    KC_NO, LSFT_T(KC_A), LCTL_T(KC_R), LALT_T(KC_S), LGUI_T(KC_T), KC_G,                     KC_M, LGUI_T(KC_N), LALT_T(KC_E), LCTL_T(KC_I), LSFT_T(KC_O), KC_NO,
...
[_M_SYM] = LAYOUT_pretty(
  ...
  _______, KC_TILD, KC_EXLM,   KC_AT, KC_HASH, KC_PIPE,                                                       KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   _______,
           _______, _______, _______, _______,                                                                         _______, _______, _______, _______,
                                                        _______, _______,                   _______, _______,
                                                                 _______,                   _______,
